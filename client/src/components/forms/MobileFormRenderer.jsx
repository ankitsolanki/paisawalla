    ...
    <ErrorBoundary>
      <div className="w-full max-w-2xl mx-auto p-4">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-6">
          ...
          {errors.submit && (
            <div className="mb-6 p-4 bg-destructive/10 border-2 border-destructive rounded-lg text-destructive text-sm flex items-center gap-2 shadow-sm">
          ...
          <div className="sticky bottom-0 bg-background pt-4 pb-4 mt-6 -mx-4 px-4 border-t border-border flex flex-col gap-2 z-50 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
